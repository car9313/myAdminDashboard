...
export default function Sidebar() {
  ...
  return (
    <aside
      className={` sticky left-0 right-0 top-0 z-50 w-full  border-r-muted md:shadow-lg transition-[width] md:bottom-0 md:right-auto md:h-svh ${isCollapsed ? "md:w-14" : "md:w-80"}`}
    >
      {/* Overlay in mobile */}
      <div
